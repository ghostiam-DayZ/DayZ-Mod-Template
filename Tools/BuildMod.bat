...
IF exist "%workDrive%%Prefix%\%ModName%\mod.cpp" (
	echo Copying over "%workDrive%%Prefix%\%ModName%\mod.cpp" to "%ModBuildDirectory%%ModName%\"
	copy "%workDrive%%Prefix%\%ModName%\mod.cpp" "%ModBuildDirectory%%ModName%\" > nul
)
